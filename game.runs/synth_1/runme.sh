...
HD_PWD='E:/FPGA/game/game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_start.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_start.tcl

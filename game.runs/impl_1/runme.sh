...
HD_PWD='E:/FPGA/game/game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_start.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_start.tcl -notrace

...
{
   static XIntc intc;
   static XSpi axi_quad_spi_flash_Spi;
...

   {
      ...
      print("\r\n Runnning SpiSelfTestExample() for axi_quad_spi_flash...\r\n");
      
      status = SpiSelfTestExample(XPAR_AXI_QUAD_SPI_FLASH_DEVICE_ID);
   ...
   }
    {
       ...
       print("\r\n Running Interrupt Test for axi_quad_spi_flash...\r\n");

       Status = SpiIntrExample(&intc, &axi_quad_spi_flash_Spi, \
                                XPAR_AXI_QUAD_SPI_FLASH_DEVICE_ID, \
                                XPAR_MICROBLAZE_0_AXI_INTC_AXI_QUAD_SPI_FLASH_IP2INTC_IRPT_INTR);
      if (Status == 0) {
